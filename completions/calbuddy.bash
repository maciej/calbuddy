...
__calbuddy_offer_flags_options() {
...
_calbuddy() {
    ...
    local -a non_repeating_flags=(-sc --separateByCalendar -sd --separateByDate -nc --noCalendarNames -ea --excludeAllDayEvents -n --includeOnlyEventsFromNowOn -uid --showUIDs -eed --excludeEndDates -sed --showEmptyDates -f --formatOutput --json -v --verbose -V --version --direct --allday -h --help)
    local -a repeating_options=(--alarm)
    local -a non_repeating_options=(-df --dateFormat -tf --timeFormat -ic --includeCals -ec --excludeCals -b --bullet -eep --excludeEventProps -iep --includeEventProps -li --limitItems --socket --title --calendar --start --end --duration --location --notes --url --uid)
...
complete -o filenames -F _calbuddy calbuddy
